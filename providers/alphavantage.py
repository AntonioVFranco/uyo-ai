...
class AlphaVantageProvider(ProviderBase):
    ...
    def get_intraday(self, q: IntradayQuery) -> pd.DataFrame:
        interval_map = {"1min": "1min", "5min": "5min", "15min": "15min", "30min": "30min", "60min": "60min"}
        iv = interval_map.get(q.interval, "5min")
        url = "https://www.alphavantage.co/query"
        params = {"function": "TIME_SERIES_INTRADAY", "symbol": q.symbol, "interval": iv, "apikey": self.api_key, "outputsize": "compact"}
